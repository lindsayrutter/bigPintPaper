...
\section*{Author's contributions}
  The software was implemented by and the paper was written by the first author primarily, based on initial ideas, consequent advice, and small contributions from the second author. 
...
\caption{Helpful resources about interactive graphics in bigPint}
      \begin{tabular}{llllll}
        ...
        Volcano plot & Figure~\ref{figureVolcano} & Link c1 & bit.ly/volcanoApp & Algorithm~\ref{algorithmVolcano} & Link c3\\
